...
import { PhoneOutlined, LogoutOutlined, ShoppingOutlined } from '@ant-design/icons';
        ...
        <Space size="large">
          ...
          {isLoggedIn && role === 'STAFF' && (
            <Button 
              ...
              size="large"
              onClick={navigateToStaffOrders}
              className="border-amber-700 text-amber-800 hover:bg-amber-100 mr-2"
            >
              Quản lý đơn hàng
            </Button>
          )}
